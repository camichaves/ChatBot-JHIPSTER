...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, chaves.camila.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, chaves.camila.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, chaves.camila.domain.Item.class.getName());
            createCache(cm, chaves.camila.domain.Cliente.class.getName());
            createCache(cm, chaves.camila.domain.Contacto.class.getName());
