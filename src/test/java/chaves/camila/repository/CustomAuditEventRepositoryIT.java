...
import chaves.camila.config.audit.AuditEventConverter;
import chaves.camila.domain.PersistentAuditEvent;
...
import static chaves.camila.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
